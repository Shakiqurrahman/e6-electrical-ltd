...
const Certification = () => {
    ...
    const certficateData = [
        {
            desq: "Landlord Certificate (Domestic)",
            price: "£120",
        },
        {
            desq: "Commercial Certificate",
            price: "Start from £180",
        },
        {
            desq: "Fire Alarm Certificate",
            price: "£70",
        },
    ];
    return (
        <section className="w-full lg:w-1/2 relative p-5 py-10 shadow-xl rounded-xl flex flex-col items-center border border-gray-200">
            <div className="absolute top-[-40px] size-20 rounded-full flex justify-center items-center p-4 bg-primary">
                <GrCertificate className="w-full text-[40px] text-white" />
            </div>
            <h1 className="text-[28px] font-semibold mt-3">Certification</h1>
